...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery);(0,_jquery2["default"])(function(){function e(){return _jquery2["default"].map(n,function(e){return(0,_jquery2["default"])(e).offset().top})}function t(){u&&(r(),u=!1),requestAnimationFrame(t)}function r(){var t=e(),r=(0,_jquery2["default"])(window).scrollTop(),u=(0,_jquery2["default"])(document).height()-(0,_jquery2["default"])(window).height(),n=a.length-1,i=t.reduce(function(e,t,a){return r>=t-100?a:r===u?n:e},-1);i!==o&&(a.forEach(function(e){e.dataset.linkActive="false"}),a[i].dataset.linkActive="true")}var u=!0,n=(0,_jquery2["default"])(".category__heading"),a=Array.prototype.slice.call(document.querySelectorAll(".willow-secondary-nav__link")),o=-1;requestAnimationFrame(t),(0,_jquery2["default"])(window).on("scroll",function(){u=!0}),a.forEach(function(e){e.addEventListener("click",function(e){e.preventDefault();var t=e.target.href.match(/.*#(.*)/)[1],r=(0,_jquery2["default"])("#"+t);(0,_jquery2["default"])("body, html").animate({scrollTop:r.offset().top},function(){window.location.hash=t,a.forEach(function(e){e.dataset.linkActive="false"}),e.target.dataset.linkActive="true"})})})});
