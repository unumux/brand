...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery);(0,_jquery2["default"])(function(){function e(){return _jquery2["default"].map(a,function(e){return(0,_jquery2["default"])(e).offset().top})}function t(){r&&(u(),r=!1),requestAnimationFrame(t)}function u(){var t=e(),u=(0,_jquery2["default"])(window).scrollTop(),r=(0,_jquery2["default"])(document).height()-(0,_jquery2["default"])(window).height(),a=n.length-1,o=t.reduce(function(e,t,n){return u===r?a:u>=t-100?n:e},-1);o!==i&&(n.attr("data-link-active",!1),n.eq(o).attr("data-link-active",!0))}var r=!0,a=(0,_jquery2["default"])(".category__heading"),n=(0,_jquery2["default"])(".secondary-nav__link"),i=-1;requestAnimationFrame(t),(0,_jquery2["default"])(window).on("scroll",function(){r=!0}),n.on("click",function(e){e.preventDefault();var t=e.target.href.match(/.*#(.*)/)[1],u=(0,_jquery2["default"])("#"+t);(0,_jquery2["default"])("body, html").animate({scrollTop:u.offset().top},function(){window.location.hash=t,n.attr("data-link-active",!1),(0,_jquery2["default"])(e.target).attr("data-link-active",!0)})})});
