...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery);(0,_jquery2.default)(function(){function e(){return _jquery2.default.map(n,function(e){return(0,_jquery2.default)(e).offset().top})}function t(){u&&(r(),u=!1),requestAnimationFrame(t)}function r(){var t=e(),r=(0,_jquery2.default)(window).scrollTop(),u=(0,_jquery2.default)(document).height()-(0,_jquery2.default)(window).height(),n=a.length-1,i=t.reduce(function(e,t,a){return 0==r?0:r>=t-100?a:r===u?n:e},-1);i!==o&&(a.forEach(function(e){e.dataset.linkActive="false"}),a[i].dataset.linkActive="true")}var u=!0,n=(0,_jquery2.default)(".category__heading"),a=Array.prototype.slice.call(document.querySelectorAll(".willow-secondary-nav__link")),o=-1;requestAnimationFrame(t),(0,_jquery2.default)(window).on("scroll",function(){u=!0}),a.forEach(function(e){e.addEventListener("click",function(e){e.preventDefault();var t=e.target.href.match(/.*#(.*)/)[1],r=(0,_jquery2.default)("#"+t);(0,_jquery2.default)("body, html").animate({scrollTop:r.offset().top},function(){window.location.hash=t,a.forEach(function(e){e.dataset.linkActive="false"}),e.target.dataset.linkActive="true"})})})});
},{"jquery":6}],4:[function(require,module,exports){
"use strict";require("./sticky-polyfill"),require("./mobile-menu"),require("./secondary-nav");
},{"./mobile-menu":2,"./secondary-nav":3,"./sticky-polyfill":5}],5:[function(require,module,exports){
...
},{"./lib/stickyfill":1,"jquery":6}],6:[function(require,module,exports){
...
"use strict";require("./mobile-menu"),require("../unum/scripts/site.js"),require("../coloniallife/scripts/site.js");
},{"../coloniallife/scripts/site.js":4,"../unum/scripts/site.js":12,"./mobile-menu":7}],9:[function(require,module,exports){
arguments[4][1][0].apply(exports,arguments)
},{"dup":1}],10:[function(require,module,exports){
arguments[4][2][0].apply(exports,arguments)
},{"dup":2}],11:[function(require,module,exports){
arguments[4][3][0].apply(exports,arguments)
},{"dup":3,"jquery":6}],12:[function(require,module,exports){
"use strict";require("./sticky-polyfill"),require("./mobile-menu"),require("./secondary-nav"),require("./typography");
},{"./mobile-menu":10,"./secondary-nav":11,"./sticky-polyfill":13,"./typography":14}],13:[function(require,module,exports){
arguments[4][5][0].apply(exports,arguments)
},{"./lib/stickyfill":9,"dup":5,"jquery":6}],14:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),circles=(0,_jquery2.default)(".table--typography .circle");(0,_jquery2.default)(function(){circles.on("mouseenter",function(){circles.blur()})});
},{"jquery":6}]},{},[8])
