...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery);(0,_jquery2["default"])(function(){function e(){return _jquery2["default"].map(r,function(e){return(0,_jquery2["default"])(e).offset().top})}function n(){l&&(a(),l=!1),requestAnimationFrame(n)}function a(){var n=e(),a=(0,_jquery2["default"])(window).scrollTop(),l=(0,_jquery2["default"])(document).height()-(0,_jquery2["default"])(window).height(),r=t.length-1,u=n.reduce(function(e,n,t){return a===l?r:a>=n-100?t:e},-1);u!==o&&(t.removeClass("willow-secondary-nav__link--active").addClass("willow-secondary-nav__link"),t.eq(u).removeClass("willow-secondary-nav__link").addClass("willow-secondary-nav__link--active"))}var l=!0,r=(0,_jquery2["default"])(".category__heading"),t=(0,_jquery2["default"])(".willow-secondary-nav__link"),o=-1;requestAnimationFrame(n),(0,_jquery2["default"])(window).on("scroll",function(){l=!0}),t.on("click",function(e){e.preventDefault();var n=e.target.href.match(/.*#(.*)/)[1],a=(0,_jquery2["default"])("#"+n);(0,_jquery2["default"])("body, html").animate({scrollTop:a.offset().top},function(){window.location.hash=n,t.removeClass("willow-secondary-nav__link--active").addClass("willow-secondary-nav__link"),(0,_jquery2["default"])(e.target).removeClass("willow-secondary-nav__link").addClass("willow-secondary-nav__link--active")})})});
